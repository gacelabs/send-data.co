<footer class="py-5 bg-dark">
	<div class="container">
		...
		<p class="m-0 text-center text-white"><a class="btn btn-default" href="https://www.facebook.com/Send-Data/" target="blank" onmouseenter="$(this).css('color', 'blue')" onmouseleave="$(this).removeAttr('style')"><i class="fa fa-facebook"></i>acebook</a></p>
